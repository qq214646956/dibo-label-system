            ...
            const defaults: SavedLayout[] = [
                {
                    ...
                    elements: [
                        ...
                        { id: 't2', type: 'text', x: 25, y: 18, w: 30, h: 8, content: "{{name}}", style: { textAlign: 'center', fontWeight: 'bold', verticalAlign: "middle" } },
                        { id: 't3', type: 'text', x: 4, y: 18, w: 20, h: 8, content: "Name : ", style: { textAlign: 'center', fontWeight: 'bold', verticalAlign: "middle" } },
                        { id: 't4', type: 'text', x: 25, y: 28, w: 30, h: 8, content: "{{designation}}", style: { textAlign: 'center', fontWeight: 'bold', verticalAlign: "middle" } },
                        { id: 't5', type: 'text', x: 4, y: 28, w: 21, h: 8, content: "Designation : ", style: { textAlign: 'center', fontWeight: 'bold', verticalAlign: "middle" } },
                        { id: 't6', type: 'text', x: 25, y: 38, w: 30, h: 8, content: "{{place}}", style: { textAlign: 'center', fontWeight: 'bold', verticalAlign: "middle" } },
                        { id: 't7', type: 'text', x: 4, y: 38, w: 20, h: 8, content: "Place :", style: { textAlign: 'center', fontWeight: 'bold', verticalAlign: "middle" } },
